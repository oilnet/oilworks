...
% But for most of the following, they can be commented out:
% ---------------------------------------------------------
...
\begin{Arabic} % Careful! LaTeX internally defined "arabic" (lowercase "a"), so Polyglossia has to use "Arabic" (uppercase "A")!
